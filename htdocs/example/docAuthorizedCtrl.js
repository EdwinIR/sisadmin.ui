...
sisAdminApp.controller('DocAuthorizedCtrl', 
      ...
      function ($scope,Restangular,$modal,$timeout) {
              ...
              $scope.dwlXml = function(fileName,legalNumber){
                     

                     if(legalNumber.charAt(0) === 'F'){
        ...
        $scope.dwlEmail = function(fileName, legalNumber, customerName) {
                ...
                var param = fileName+","+ legalNumber+","+ customerName+",";  
              ...
              $scope.bajaDocumento = function(documento) {
                                            ...
                                            var modalInstance = $modal.open({
                                                      templateUrl: 'BajaModalConfirm.html',
                                                      controller: 'BajaModalInstanceCtrl',
                                                      resolve: {
                                  items: function () {
                                        return $scope.items;}}
                          });
