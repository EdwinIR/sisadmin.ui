...
sisAdminApp.controller('ResumenBaja', 
      ...
      function ($scope,Restangular,$modal,$timeout) {
              ...
              var rDocumentTypes = Restangular.all('combo/resumenbaja/list');
              rDocumentTypes.getList().then(function(response){
                          $scope.listResumenBajaTypes =response.data;
              });
            ...
            $scope.filter = function() {
              ...
              var applyFilter = function (filterData) {
                      ...
                      $scope.pbValue=50;
                      Restangular.one('resumenbaja').post('filter',filterData).then(function(response) {
