...
sisAdminApp.controller('SaSaldoXProductoCtrl', ['$scope', 'Restangular', '$modal',
    function($scope, Restangular, $modal) {
        ...
        $scope.find = function(){
          $scope.paEnvio.almacenId = $scope.productoAlmacen.almacen.id;
          $scope.paEnvio.marcaId = $scope.productoAlmacen.marca.id;
          $scope.paEnvio.familiaId = $scope.productoAlmacen.familia.id;
          Restangular.all('saldoporproducto/find').post($scope.paEnvio).then(function(response) {
            $scope.productoAlmacenes = response.data;
          });
        };
